/**
 * Problem: Remove Colored Pieces if Both Neighbors are the Same Color (LeetCode 2038)
...
int main() {
    ...
    // cout << "Testing Remove Colored Pieces if Both Neighbors are the Same Color" << endl;
    // solveOptimal();
