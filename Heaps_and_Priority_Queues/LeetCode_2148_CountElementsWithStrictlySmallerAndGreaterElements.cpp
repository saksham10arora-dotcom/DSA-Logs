/**
 * Problem: Count Elements With Strictly Smaller and Greater Elements  (LeetCode 2148)
...
int main() {
    ...
    // cout << "Testing Count Elements With Strictly Smaller and Greater Elements " << endl;
    // solveOptimal();
