/**
 * Problem: Longest Arithmetic Sequence After Changing At Most One Element (LeetCode 3872)
...
int main() {
    ...
    // cout << "Testing Longest Arithmetic Sequence After Changing At Most One Element" << endl;
    // solveOptimal();
