/**
 * Problem: Count of Substrings Containing Every Vowel and K Consonants I (LeetCode 3305)
...
int main() {
    ...
    // cout << "Testing Count of Substrings Containing Every Vowel and K Consonants I" << endl;
    // solveOptimal();
