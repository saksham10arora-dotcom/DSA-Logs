/**
 * Problem: Find the Longest Substring Containing Vowels in Even Counts (LeetCode 1371)
...
int main() {
    ...
    // cout << "Testing Find the Longest Substring Containing Vowels in Even Counts" << endl;
    // solveOptimal();
