/**
 * Problem: Maximize the Number of Target Nodes After Connecting Trees I (LeetCode 3372)
...
int main() {
    ...
    // cout << "Testing Maximize the Number of Target Nodes After Connecting Trees I" << endl;
    // solveOptimal();
