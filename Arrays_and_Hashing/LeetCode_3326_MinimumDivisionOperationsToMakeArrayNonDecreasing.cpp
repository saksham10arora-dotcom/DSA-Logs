/**
 * Problem: Minimum Division Operations to Make Array Non Decreasing (LeetCode 3326)
...
int main() {
    ...
    // cout << "Testing Minimum Division Operations to Make Array Non Decreasing" << endl;
    // solveOptimal();
