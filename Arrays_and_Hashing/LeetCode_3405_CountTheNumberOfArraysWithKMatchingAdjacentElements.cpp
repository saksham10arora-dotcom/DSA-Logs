/**
 * Problem: Count the Number of Arrays with K Matching Adjacent Elements (LeetCode 3405)
...
int main() {
    ...
    // cout << "Testing Count the Number of Arrays with K Matching Adjacent Elements" << endl;
    // solveOptimal();
