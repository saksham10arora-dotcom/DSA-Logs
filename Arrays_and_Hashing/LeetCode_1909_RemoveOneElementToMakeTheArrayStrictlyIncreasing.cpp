/**
 * Problem: Remove One Element to Make the Array Strictly Increasing (LeetCode 1909)
...
int main() {
    ...
    // cout << "Testing Remove One Element to Make the Array Strictly Increasing" << endl;
    // solveOptimal();
