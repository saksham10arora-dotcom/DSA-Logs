/**
 * Problem: Longest Alternating Subarray After Removing At Most One Element (LeetCode 3830)
...
int main() {
    ...
    // cout << "Testing Longest Alternating Subarray After Removing At Most One Element" << endl;
    // solveOptimal();
