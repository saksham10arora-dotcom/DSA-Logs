/**
 * Problem: Maximize Subarray Sum After Removing All Occurrences of One Element (LeetCode 3410)
...
int main() {
    ...
    // cout << "Testing Maximize Subarray Sum After Removing All Occurrences of One Element" << endl;
    // solveOptimal();
