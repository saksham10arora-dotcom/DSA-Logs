/**
 * Problem: Longest Palindromic Subsequence After at Most K Operations (LeetCode 3472)
...
int main() {
    ...
    // cout << "Testing Longest Palindromic Subsequence After at Most K Operations" << endl;
    // solveOptimal();
